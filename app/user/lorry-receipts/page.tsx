  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Lorry Receipts / Bilty</h1>
          <p className="text-muted-foreground text-sm">Manage all your transport documents</p>
        </div>
        <Link 
