...
import { Download, Edit, Printer, Mail, X, Send } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-4 shrink-0 px-2 print:hidden">
        <div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <FileText className="w-6 h-6 text-[#5b21b6]" /> View Vehicle Condition
          </h1>
        </div>
        <div className="flex flex-nowrap whitespace-nowrap items-center gap-4 print:hidden overflow-x-auto custom-scrollbar pb-1">
          <Link href="/user/vehicle-conditions" className="text-[#5b21b6] hover:underline flex items-center gap-2 font-medium text-sm mr-4">
            <ArrowLeft className="w-4 h-4" /> Back to Vehicle Conditions
          </Link>
          <button 
            onClick={handlePrint}
