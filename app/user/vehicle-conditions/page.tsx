  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-row items-center justify-between gap-2 sm:gap-4 bg-card py-2 px-3 sm:px-4 rounded-lg shadow-sm border border-primary/20 mb-4 sm:mb-6">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-foreground truncate">Vehicle Condition Reports</h1>
          <p className="text-muted-foreground text-xs sm:text-sm truncate hidden sm:block">Manage your vehicle condition reports</p>
        </div>
        <Link 
